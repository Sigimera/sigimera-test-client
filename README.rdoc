= Sigimera Test Client

Here you will find further information how to use the testing application that
make use of the Sigimera API (http://api.sigimera.org/)
...
* If you plan to develop and application that makse use of the REST API (http://api.sigimera.org) provided by the Sigimera Platform you can checkout this project and play around with the examples.
